#!/bin/bash
#SBATCH --job-name=help_dna_align      ## Name of the job.
...
inpath="/data/class/ecoevo283/jabermud/lab_hours/DNAseq/"
file=$inpath"prefixes_DNA.txt" # prefix file
ref="/data/class/ecoevo283/jabermud/lab_hours/ref/dmel-all-chromosome-r6.13.fasta"
prefix=`head -n $SLURM_ARRAY_TASK_ID  ${file} | tail -n 1`

# alignments
bwa mem -t 2 -M $ref ${inpath}rawdata/${prefix}_1.fq.gz ${inpath}rawdata/${prefix}_2.fq.gz | samtools view -bS - > ${inpath}mapped/${prefix}.bam
